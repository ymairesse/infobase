...
?>
<p><?php echo "<strong>$r1</strong>"; ?>&nbsp;Barre de titre: elle
contient le titre de la fenêtre; sa
couleur change selon que la fenêtre est active ou inactive</p>
<p><?php echo "<strong>$r2</strong>"; ?> Case de réduction: c'est
un carré marqué d'un trait
horizontal dans le bas de la case</p>
<p><?php echo "<strong>$r3</strong>"; ?>&nbsp;Case d'agrandissement:
c'est un carré marqué d'un trait
horizontal dans le haut de la case</p>
<p><?php echo "<strong>$r4</strong>"; ?>&nbsp;Case du menu système:
c'est un carré contenant l'icone du
programme en réduction</p>
<p><?php echo "<strong>$r5</strong>"; ?>&nbsp;Case de fermeture: c'est
un carré contenant une croix.</p>
...
<p class="invisible" style="text-align: center;">Cliquer 
