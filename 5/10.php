...
<head>
  ...
  <link rel="timesheet" type="application/smil+xml" href="10/timesheet.smil">
	...
	<div id="conteneur">
		...
		<div id="texte"  class="crossfade">
			...
			<div id="slideshow" style="position: relative; height:600px">
				<header id="slide01">	<img src="10/img0.jpg" alt="img">	</header>
				<div id="slide02">		<img src="10/img1.jpg" alt="img">	</div>
				<div id="slide03">		<img src="10/img2.jpg" alt="img">	</div>
				<div id="slide04">		<img src="10/img3.jpg" alt="img">	</div>
				<div id="slide05">		<img src="10/img4.jpg" alt="img">	</div>
				<footer id="slide06">		<img src="10/img5.jpg" alt="img">	</footer>

			</div>
			<!-- id="slideshow" -->
			
			<audio id="talk" preload>
				<source type="audio/mp3" src="10/01.mp3" />
				<source type="audio/ogg" src="10/01.ogg" />
			</audio>
			...
			<nav id="timeController" class="smil-timeController">
				...
				<div class="smil-toc" style="display: none;">
					<ul class="smil-tocList">
						<li><a href="#slide01"> Partie 5 : Quelques touches remarquables </a></li>
						<li><a href="#slide02"> Le pavé numérique </a></li>
						<li><a href="#slide03"> Les opérateurs arithmétiques </a></li>
						<li><a href="#slide04"> Les touches de fonctions </a></li>
						<li><a href="#slide05"> la touche d'échappement ESC </a></li>
						<li><a href="#slide06"> la touche de tabulation </a></li>
					</ul>
				</div>
				<!-- Table of Contentes -->
...
<p>Quand tu as bien noté et compris toutes les informations, passe à la page suivante pour quelques exercices.<?php include ("../../suivant.inc.php");?></p>
	  </div>
		<!-- id="texte" -->
