...
<body>
  <div id="conteneur">
    ...
    <div id="texte">
      ...
      <fieldset class="info">
        <legend>Important: à retenir</legend>
        <h3>Il est indispensable de retenir</h3>
        <ol>
          <li>Les <strong>noms</strong> des multiples de l'octet: Kilo, Méga, Giga et Téra (au minimum)</li>
          <li>Les <strong>valeurs relatives</strong> des multiples: 1 To = 1000 Go = 1000 x 1000 Mo = 1000 x 1000 x 1000 Ko</li>
          <li>La <strong>correspondance en anglais</strong>: 1 TB = 1000 GB = 1000 x 1000 MB = 1000 x 1000 x 1000 KB</li>
        </ol>
      ...
      <fieldset class="qcu">
        <form action="" >
<img src="images/fichiers.png" alt="fichiers" width="371" class="imagedroite">Dans mon navigateur de fichiers, je vois quatre fichiers (illustration ci-contre).<br />
Lequel de ces fichiers est le plus lourd en nombre d'octets?<br>
<input class="qcm" name="qcm1" type="radio">Le fichier fichier1.pdf<br><p class="vrai">Exact.<br>Il "pèse" 3,8 millions d'octets</p>
<input class="qcm" name="qcm1" type="radio">Le fichier fichier2.stl<br><p class="faux">Réponse fausse.<br>D'autres fichiers sont bien plus lourds.</p>
<input class="qcm" name="qcm1" type="radio">Le fichier fichier3.odt<br><p class="faux">Réponse fausse.<br>Ce n'est pas le plus lourd. Pense bien à la signification du "k" et à celle d'autres préfixes multiplicateurs que l'on voit.</p>
<input class="qcm" name="qcm1" type="radio">Le fichier fichier4.html<br><p class="faux">Ce n'est pas la bonne réponse.<br>Ce n'est pas le plus lourd. Pense bien à la signification du "k" et à celle d'autres préfixes multiplicateurs que l'on voit.</p>
</form>
</fieldset>
      ...
      <fieldset class="qcu">
      <form action="javascript:void(0)">
        On te demande de transcrire à la main tous les octets issus des expériences du LHC chaque année. Imaginons que tu sois capable d'écrire le contenu d'un octet (un nombre compris entre 0 et 255) chaque seconde. Combien de temps te faudra-t-il pour transcrire 15 000 millions de Giga-octets?<br>
