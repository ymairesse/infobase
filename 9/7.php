...
<head>
  ...
  <link rel="timesheet" type="application/smil+xml" href="7/timesheet.smil">
...
<body>
 ...
 <h2>L'adresse IP des ordinateurs</h2>
    ...
    <div class="travail">
     ...
     <h3 class="cache-cache">Clique ici pour obtenir les instructions pour Windows XP</h3>
	...
	<h3 class="cache-cache">Clique ici pour obtenir les instructions pour Windows Vista/Seven</h3>
    <div class="travail" style="display:none">
      ...
      <h3 class="cache-cache">Clique ici pou obtenir les instructions pour&nbsp;Linux</h3>
      <div class="travail" style="display:none">
        <ul>
          <li><img class="imagedroite" src="images/terminal.png" alt="terminal">Sous Ubuntu / Unity, clique sur le "Tableau de bord"</li>
		  <li>Écris les premières lettres du mot "terminal"</li>
		  <li>Clique sur l'icône du terminal qui apparaît après un court intervalle de temps</li>
          <li>Frappes-y la commande <strong>ifconfig</strong></li>
          <li>Observe quelques instants les informations reçues puis lis l'explication ci-dessous.</li>
        </ul>
        <p style="text-align: center;"><img src="images/ifconfig.png" style="width: 722px; height: 228px;" alt="/sbin/ifconfig"></p>
        <p class="info">Parmi les informations retournées, l'adresse IP : inet addr: 192.168.0.3 sur l'illustration ci-dessus. C'est ton adresse IP.</p>
