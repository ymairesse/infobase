<?php
session_start();
$data = array_reverse(explode('/', $_SERVER['PHP_SELF']));
$chapitre = $data[1];
$matiere = $data[2];
?>
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../print.css" media="print"><title>&lt;?php echo $titre; ?&gt;</title></head><body>
<div id="conteneur">
<?php include ("./top.inc.php"); ?>
<div id="texte">
<h2> Ton avis m'intéresse </h2>
<p> Afin d'améliorer ce cours, il me serait utile de disposer de quelques informations sur la façon dont tu l'as perçu. Cela m'aiderait beaucoup que tu répondes rapidement aux quelques questions suivantes. Tu n'es pas obligé(e) de répondre à toutes les questions. </p>
<form name="form1" method="post" action="../../envavis.php">
  ...
  <p style="text-align: center;"> <input name="Submit" value="Envoyer" type="submit"> </p>
    <?php // indication des matières et chapitre
$texte = <<<EOF
  <input name="chapitre" value="##chapitre##" type="hidden">
  <input name="matiere" value="##matiere##" type="hidden"> 
EOF;
