...
<html><head><title>Internet est comme une bibliothèque publique</title>
...
<table style="text-align: left; width: 100%;" border="1" cellpadding="2" cellspacing="2">
    <tbody>
      ...
      <td style="vertical-align: top;">Tous les documents sont soigneusement choisis pour leur qualité</td>
      <td style="vertical-align: top; text-align: center;">
			<?php if (isset($bibChoix)) echo "X"; ?><br>
	  </td>
      <td style="vertical-align: top; text-align: center;">
			<?php if (isset($netChoix)) echo "X"; ?><br>
      </td>
    </tr>
