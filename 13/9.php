...
$matiere = "infobase";
$chapitre = 13;
$titre = "La recherche sur l'Internet";
?>
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../print.css" media="print"><title>La recherche sur l'Internet</title></head><body>
<?php include ("./top.inc.php"); ?>
<div id="texte">
<h2>Ton avis m'intéresse</h2>
<p> Afin d'améliorer ce cours, il me serait utile de disposer de
quelques informations sur la façon dont tu l'as perçu. Cela m'aiderait
beaucoup que tu répondes rapidement aux quelques questions suivantes.
